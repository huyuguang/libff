...
void mnt6_G1::print_coordinates() const {
  if (this->is_zero()) {
    ...
    gmp_printf("(%Nd : %Nd : %Nd)\n", this->X_.as_bigint().data,
               mnt6_Fq::num_limbs, this->Y_.as_bigint().data,
               mnt6_Fq::num_limbs, this->Z_.as_bigint().data,
               mnt6_Fq::num_limbs);
  }
}
...
mnt6_G1 mnt6_G1::operator+(const mnt6_G1 &other) const {
  ...
  */
  ...
  if (X1Z2 == X2Z1 && Y1Z2 == Y2Z1) {
    ...
    const mnt6_Fq w =
        mnt6_G1::coeff_a * ZZ + (XX + XX + XX);  // w   = a*ZZ + 3*XX
...
bool mnt6_G1::is_well_formed() const {
  if (this->is_zero()) {
    ...
    */
    ...
    return (this->Z_ * (Y2 - mnt6_G1::coeff_b * Z2) ==
            this->X_ * (X2 + mnt6_G1::coeff_a * Z2));
  }
}
