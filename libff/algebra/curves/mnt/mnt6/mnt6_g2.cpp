...
mnt6_G2 &mnt6_G2::G2_zero() {
  static mnt6_G2 _G2_zero_(constructor_dummy_t{});
  return _G2_zero_;
}
mnt6_G2 &mnt6_G2::G2_one() {
  static mnt6_G2 _G2_one_(constructor_dummy_t{});
  return _G2_one_;
}
...
mnt6_G2 mnt6_G2::operator+(const mnt6_G2 &other) const {
  ...
  */
  ...
  if (X1Z2 == X2Z1 && Y1Z2 == Y2Z1) {
    ...
    const mnt6_Fq3 w =
        mnt6_G2::mul_by_a(ZZ) + (XX + XX + XX);  // w   = a*ZZ + 3*XX
