...
edwards_G2 &edwards_G2::G2_zero() {
  static edwards_G2 _G2_zero_(constructor_dummy_t{});
  return _G2_zero_;
}
edwards_G2 &edwards_G2::G2_one() {
  static edwards_G2 _G2_one_(constructor_dummy_t{});
  return _G2_one_;
}
...
edwards_Fq3 edwards_G2::mul_by_a(const edwards_Fq3 &elt) {
  // should be
  //  edwards_Fq3(edwards_twist_mul_by_a_c0 * elt.c2, edwards_twist_mul_by_a_c1
...
edwards_Fq3 edwards_G2::mul_by_d(const edwards_Fq3 &elt) {
  return edwards_Fq3(edwards_twist_mul_by_d_c0 * elt.c2,
...
edwards_G2 edwards_G2::add(const edwards_G2 &other) const {
  ...
  const edwards_Fq3 I = (this->X + this->Y) * (other.X + other.Y) - C -
                        D;             // I = (X1+Y1)*(X2+Y2)-C-D
...
edwards_G2 edwards_G2::zero() { return G2_zero(); }

edwards_G2 edwards_G2::one() { return G2_one(); }
