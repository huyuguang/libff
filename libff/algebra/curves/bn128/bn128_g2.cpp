...
bn128_G2 &bn128_G2::G2_zero() {
  static bn128_G2 _G2_zero_(constructor_dummy_t{});
  return _G2_zero_;
}
bn128_G2 &bn128_G2::G2_one() {
  static bn128_G2 _G2_one_(constructor_dummy_t{});
  return _G2_one_;
}
...
void bn128_G2::print() const {
  if (this->is_zero()) {
    ...
    std::cout << "(" << copy.coord[0].toString(10) << " : "
              << copy.coord[1].toString(10) << " : "
              << copy.coord[2].toString(10) << ")\n";
  }
}
...
void bn128_G2::print_coordinates() const {
  if (this->is_zero()) {
    ...
    std::cout << "(" << coord[0].toString(10) << " : " << coord[1].toString(10)
              << " : " << coord[2].toString(10) << ")\n";
  }
}
...
void bn128_G2::to_special() { this->to_affine_coordinates(); }

bool bn128_G2::is_special() const {
  return (this->is_zero() || this->coord[2] == 1);
}

bool bn128_G2::is_zero() const { return coord[2].isZero(); }
...
std::ostream &operator<<(std::ostream &out, const bn128_G2 &g) {
  ...
  out << OUTPUT_SEPARATOR
      << (((unsigned char *)&gcopy.coord[1].a_)[0] & 1 ? '1' : '0');
#endif
