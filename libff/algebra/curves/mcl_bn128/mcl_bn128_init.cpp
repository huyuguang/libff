...
void init_mcl_bn128_params()
{
    ...
    /* choice of group G1 */
    mcl_bn128_G1::G1_zero().pt.x = Fp(0);
    ...
    /* choice of group G2 */
    mcl_bn128_G2::G2_zero().pt.x = Fp2(Fp(0), Fp(0));
    mcl_bn128_G2::G2_zero().pt.y = Fp2(Fp(1), Fp(0));
    mcl_bn128_G2::G2_zero().pt.z = Fp2(Fp(0), Fp(0));

#ifdef MCL_COMPATIBLE_BN128
    // compatible with bn128
...
#else
    // compatible with alt_bn128
    mcl_bn128_G2::G2_one().pt.x = Fp2(Fp("10857046999023057135944570762232829481370756359578518086990519993285655852781"),
                                        Fp("11559732032986387107991004021392285783925812861821192530917403151452391805634"));
    mcl_bn128_G2::G2_one().pt.y = Fp2(Fp("8495653923123431417604973247489272438418190587263600148770280649306958101930"),
